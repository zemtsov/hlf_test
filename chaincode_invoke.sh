...
docker exec \
    ...
    cli \
    peer chaincode invoke -C $CHANNEL_NAME -o orderer.example.com:7050 -n ${CC_NAME} --peerAddresses peer0.org1.example.com:7051 --peerAddresses peer0.org2.example.com:9051 -c '{"Args": ["store", "value1", "345"]}' >&log.txt
